try {
    let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
        e = (new t.Error).stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "036579d2-44cc-4cb1-a162-75aad30204b6", t._sentryDebugIdIdentifier = "sentry-dbid-036579d2-44cc-4cb1-a162-75aad30204b6")
} catch (t) {}
"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [9240], {
        60737: function(t, e, n) {
            n.d(e, {
                Ig: function() {
                    return x
                },
            ...
            var r = n(26151),
                i = n(30764),
                s = n(27191);
            let o = (t, e) => !t.selection.empty && (e && e(t.tr.deleteSelection().scrollIntoView()), !0);
            ...
            let a = (t, e, n) => {
                    ...
                    let h = a.nodeBefore;
                    if (A(t, a, e, -1)) return !0;
                    if (0 == o.parent.content.size && (f(h, "end") || s.qv.isSelectable(h)))
                        for (let n = o.depth;; n--) {
                            let l = (0, r.dR)(t.doc, o.before(n), o.after(n), i.p2.empty);
                            if (l && l.slice.size < l.to - l.from) {
                                if (e) {
                                    let n = t.tr.step(l);
                                    n.setSelection(f(h, "end") ? s.Y1.findFrom(n.doc.resolve(n.mapping.map(a.pos, -1)), -1) : s.qv.create(n.doc, a.pos - h.nodeSize)), e(n.scrollIntoView())
                                }
                                return !0
                            }
                            if (1 == n || o.node(n - 1).childCount > 1) break
                        }
                    return !!h.isAtom && a.depth == o.depth - 1 && (e && e(t.tr.delete(a.pos - h.nodeSize, a.pos).scrollIntoView()), !0)
                },
                h = (t, e, n) => {
                    let r = l(t, n);
                    if (!r) return !1;
            ...
            function p(t, e, n) {
                ...
                let c = (0, r.dR)(t.doc, l, h, i.p2.empty);
                if (!c || c.from != l || c instanceof r.Pu && c.slice.size >= h - l) return !1;
                if (n) {
                    let e = t.tr.step(c);
                    e.setSelection(s.Bs.create(e.doc, l)), n(e.scrollIntoView())
                }
                return !0
            }
            ...
            let u = (t, e, n) => {
                ...
                return !!(l && s.qv.isSelectable(l)) && (e && e(t.tr.setSelection(s.qv.create(t.doc, o.pos - l.nodeSize)).scrollIntoView()), !0)
            };
            ...
            let g = (t, e, n) => {
                    ...
                    if (!l) return !1;
                    let a = l.nodeAfter;
                    if (A(t, l, e, 1)) return !0;
                    if (0 == o.parent.content.size && (f(a, "start") || s.qv.isSelectable(a))) {
                        let n = (0, r.dR)(t.doc, o.before(), o.after(), i.p2.empty);
                        if (n && n.slice.size < n.to - n.from) {
                            if (e) {
                                let r = t.tr.step(n);
                                r.setSelection(f(a, "start") ? s.Y1.findFrom(r.doc.resolve(r.mapping.map(l.pos)), 1) : s.qv.create(r.doc, r.mapping.map(l.pos))), e(r.scrollIntoView())
                            }
                            return !0
                        }
                    }
                    return !!a.isAtom && l.depth == o.depth - 1 && (e && e(t.tr.delete(l.pos, l.pos + a.nodeSize).scrollIntoView()), !0)
                },
                y = (t, e, n) => {
                    let {
                        $head: r,
                    ...
                    let l = o && o.nodeAfter;
                    return !!(l && s.qv.isSelectable(l)) && (e && e(t.tr.setSelection(s.qv.create(t.doc, o.pos)).scrollIntoView()), !0)
                };
            ...
            let w = (t, e) => {
                    ...
                    if (i) {
                        ...
                        o = n.from
                    } else if (null == (o = (0, r.GJ)(t.doc, n.from, -1))) return !1;
                    if (e) {
                        let n = t.tr.join(o);
                        i && n.setSelection(s.qv.create(n.doc, o - t.doc.resolve(o).nodeBefore.nodeSize)), e(n.scrollIntoView())
                    }
                    return !0
                },
                x = (t, e) => {
                ...
                S = (t, e) => {
                    let {
                        $from: n,
                        $to: i
                    } = t.selection, s = n.blockRange(i), o = s && (0, r.k9)(s);
            ...
            let C = (t, e) => {
                    ...
                    let i = n.node(-1),
                        o = n.indexAfter(-1),
                        l = b(i.contentMatchAt(o));
                    if (!l || !i.canReplaceWith(o, o, l)) return !1;
                    if (e) {
                        let r = n.after(),
                            i = t.tr.replaceWith(r, r, l.createAndFill());
                        i.setSelection(s.Y1.near(i.doc.resolve(r), 1)), e(i.scrollIntoView())
                    }
                    return !0
                },
                M = (t, e) => {
                    ...
                    if (n instanceof s.C1 || r.parent.inlineContent || i.parent.inlineContent) return !1;
                    let o = b(i.parent.contentMatchAt(i.indexAfter()));
                    if (!o || !o.isTextblock) return !1;
                    if (e) {
                        let n = (!r.parentOffset && i.index() < i.parent.childCount ? r : i).pos,
                            l = t.tr.insert(n, o.createAndFill());
                        l.setSelection(s.Bs.create(l.doc, n + 1)), e(l.scrollIntoView())
                    }
                    return !0
                },
                T = (t, e) => {
                ...
                O = (t, e) => {
                    let {
                        $from: n,
                        to: r
                    } = t.selection, i, o = n.sharedDepth(r);
                    return 0 != o && (i = n.before(o), e && e(t.tr.setSelection(s.qv.create(t.doc, i))), !0)
                };

            function A(t, e, n, o) {
                let l, a, h, c = e.nodeBefore,
                    p = e.nodeAfter,
                    u, d, m = c.type.spec.isolating || p.type.spec.isolating;
                if (!m && (l = e.nodeBefore, a = e.nodeAfter, h = e.index(), l && a && l.type.compatibleContent(a.type) && (!l.content.size && e.parent.canReplace(h - 1, h) ? (n && n(t.tr.delete(e.pos - l.nodeSize, e.pos).scrollIntoView()), !0) : !!(e.parent.canReplace(h, h + 1) && (a.isTextblock || (0, r.Mn)(t.doc, e.pos))) && (n && n(t.tr.join(e.pos).scrollIntoView()), !0)))) return !0;
                let g = !m && e.parent.canReplace(e.index(), e.index() + 1);
                if (g && (u = (d = c.contentMatchAt(c.childCount)).findWrapping(p.type)) && d.matchType(u[0] || p.type).validEnd) {
                    if (n) {
                        let s = e.pos + p.nodeSize,
                            o = i.HY.empty;
                        for (let t = u.length - 1; t >= 0; t--) o = i.HY.from(u[t].create(null, o));
                        o = i.HY.from(c.copy(o));
                        let l = t.tr.step(new r.FC(e.pos - 1, s, e.pos, s, new i.p2(o, 1, 0), u.length, !0)),
                            a = l.doc.resolve(s + 2 * u.length);
                        a.nodeAfter && a.nodeAfter.type == c.type && (0, r.Mn)(l.doc, a.pos) && l.join(a.pos), n(l.scrollIntoView())
                    }
                    return !0
                }
                let y = p.type.spec.isolating || o > 0 && m ? null : s.Y1.findFrom(e, 1),
                    k = y && y.$from.blockRange(y.$to),
                    w = k && (0, r.k9)(k);
                if (null != w && w >= e.depth) return n && n(t.tr.lift(k, w).scrollIntoView()), !0;
                if (g && f(p, "start", !0) && f(c, "end")) {
                    let s = c,
                        o = [];
                    ...
                    if (s.canReplace(s.childCount, s.childCount, l.content)) {
                        if (n) {
                            let s = i.HY.empty;
                            for (let t = o.length - 1; t >= 0; t--) s = i.HY.from(o[t].copy(s));
                            n(t.tr.step(new r.FC(e.pos - o.length, e.pos + p.nodeSize, e.pos + a, e.pos + p.nodeSize - a, new i.p2(s, o.length, 0), 0, !0)).scrollIntoView())
                        }
                        return !0
                    }
                }
            ...
            function E(t) {
                return function(e, n) {
                    ...
                    return !!i.node(o).isTextblock && (n && n(e.tr.setSelection(s.Bs.create(e.doc, t < 0 ? i.start(o) : i.end(o)))), !0)
                }
            }
            let I = E(-1),
                N = E(1);
            ...
            function R(t, e = null) {
                return function(n, i) {
                    let {
                        $from: s,
                        $to: o
                    } = n.selection, l = s.blockRange(o), a = l && (0, r.nd)(l, t, e);
                    return !!a && (i && i(n.tr.wrap(l, a).scrollIntoView()), !0)
                }
            }
            ...
            let $ = F(o, a, u),
                ...
                J = {
                    Enter: F(v, M, T, (t, e) => {
                        ...
                        if (t.selection instanceof s.qv && t.selection.node.isBlock) return !!(n.parentOffset && (0, r.Ax)(t.doc, n.pos)) && (e && e(t.tr.split(n.pos).scrollIntoView()), !0);
                        if (!n.depth) return !1;
                        let o = [],
                            l, a, h = !1,
                            c = !1;
                        for (let t = n.depth;; t--) {
                            if (n.node(t).isBlock) {
                                let e;
                                h = n.end(t) == n.pos + (n.depth - t), c = n.start(t) == n.pos - (n.depth - t), a = b(n.node(t - 1).contentMatchAt(n.indexAfter(t - 1))), o.unshift(e || (h && a ? {
                                    type: a
                                } : null)), l = t;
                                break
                            }
                        ...
                        let p = t.tr;
                        (t.selection instanceof s.Bs || t.selection instanceof s.C1) && p.deleteSelection();
                        let f = p.mapping.map(n.pos),
                            u = (0, r.Ax)(p.doc, f, o.length, o);
                        if (u || (o[0] = a ? {
                                type: a
                            } : null, u = (0, r.Ax)(p.doc, f, o.length, o)), !u) return !1;
                        if (p.split(f, o.length, o), !h && c && n.node(l).type != a) {
                            let t = p.mapping.map(n.before(l)),
                                e = p.doc.resolve(t);
                            a && n.node(l - 1).canReplaceWith(e.index(), e.index() + 1, a) && p.setNodeMarkup(p.mapping.map(n.before(l)), a)
                        }
                        return e && e(p.scrollIntoView()), !0
                    }),
                    "Mod-Enter": C,
                    Backspace: $,
                    "Mod-Backspace": $,
                    ...
                    Delete: B,
                    "Mod-Delete": B,
                    "Mod-a": (t, e) => (e && e(t.tr.setSelection(new s.C1(t.doc))), !0)
                },
                D = {
                    "Ctrl-h": J.Backspace,
        ...
        49080: function(t, e, n) {
            ...
            for (var r = {
                    ...
                    221: "}",
                    222: '"'
                }, s = "undefined" != typeof navigator && /Mac/.test(navigator.platform), o = "undefined" != typeof navigator && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent), l = 0; l < 10; l++) r[48 + l] = r[96 + l] = String(l);
            ...
            var h = n(27191);
            let c = "undefined" != typeof navigator && /Mac|iP(hone|[oa]d)/.test(navigator.platform);
                ...
                let e = function(t) {
                    ...
                    for (let n in t) e[function(t) {
                        ...
                        for (let t = 0; t < s.length - 1; t++) {
                            ...
                            else if (/^mod$/i.test(o)) c ? i = !0 : n = !0;
                            else throw Error("Unrecognized modifier name: " + o)
                        }
                        return e && (o = "Alt-" + o), n && (o = "Ctrl-" + o), i && (o = "Meta-" + o), r && (o = "Shift-" + o), o
                    }(n)] = t[n];
                    return e
                }(t);
                return function(t, n) {
                    var l;
                    let a = ("Esc" == (l = !(s && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || o && n.shiftKey && n.key && 1 == n.key.length || "Unidentified" == n.key) && n.key || (n.shiftKey ? i : r)[n.keyCode] || n.key || "Unidentified") && (l = "Escape"), "Del" == l && (l = "Delete"), "Left" == l && (l = "ArrowLeft"), "Up" == l && (l = "ArrowUp"), "Right" == l && (l = "ArrowRight"), "Down" == l && (l = "ArrowDown"), l),
                        h, c = e[p(a, n)];
                    ...
                    if (1 == a.length && " " != a) {
                        ...
                        if ((n.shiftKey || n.altKey || n.metaKey || a.charCodeAt(0) > 127) && (h = r[n.keyCode]) && h != a) {
                            let r = e[p(h, n)];
                            if (r && r(t.state, t.dispatch, t)) return !0
                        }
                    }
        ...
        30764: function(t, e, n) {
                    ...
                    if (e > t)
                        for (let i = 0, s = 0; s < e; i++) {
                            let o = this.content[i],
                                l = s + o.nodeSize;
                            l > t && ((s < t || l > e) && (o = o.isText ? o.cut(Math.max(0, t - s), Math.min(o.text.length, e - s)) : o.cut(Math.max(0, t - s - 1), Math.min(o.content.size, e - s - 1))), n.push(o), r += o.nodeSize), s = l
                        }
                    return new i(n, r)
                }
                cutByIndex(t, e) {
            ...
            function d(t, e, n, r) {
                ...
                t && (s = t.index(n), t.depth > n ? s++ : t.textOffset && (u(t.nodeAfter, r), s++));
                for (let t = s; t < o; t++) u(i.child(t), r);
                e && e.depth == n && e.textOffset && u(e.nodeBefore, r)
            }
            ...
            function g(t, e, n) {
                let r = [];
                return d(null, t, n, r), t.depth > n && u(m(f(t, e, n + 1), g(t, e, n + 1)), r), d(e, null, n, r), new i(r)
            }
            ...
            class y {
                ...
                blockRange(t = this, e) {
                    ...
                    for (let n = this.depth - (this.parent.inlineContent || this.pos == t.pos ? 1 : 0); n >= 0; n--)
                        if (t.pos <= this.end(n) && (!e || e(this.node(n)))) return new S(this, t, n);
                    return null
                }
                sameParent(t) {
                ...
                static resolveCached(t, e) {
                    ...
                    if (n)
                        for (let t = 0; t < n.elts.length; t++) {
                            let r = n.elts[t];
                            if (r.pos == e) return r
                        } else x.set(t, n = new k);
                    let r = n.elts[n.i] = y.resolve(t, e);
                    return n.i = (n.i + 1) % w, r
                }
            }
            class k {
                constructor() {
            ...
            class b {
                ...
                slice(t, e = this.content.size, n = !1) {
                    ...
                    let r = this.resolve(t),
                        ...
                        o = r.start(s);
                    return new c(r.node(s).content.cut(r.pos - o, i.pos - o), r.depth - s, i.depth - s)
                }
                replace(t, e, n) {
                    return function(t, e, n) {
                        ...
                        return function t(e, n, r, s) {
                            ...
                            if (r.openStart || r.openEnd || e.depth != s || n.depth != s) {
                                ...
                                return m(l, function t(e, n, r, s, o) {
                                    let l = e.depth > o && f(e, n, o + 1),
                                        a = s.depth > o && f(r, s, o + 1),
                                        h = [];
                                    return d(null, e, o, h), l && a && n.index(o) == r.index(o) ? (p(l, a), u(m(l, t(e, n, r, s, o + 1)), h)) : (l && u(m(l, g(e, n, o + 1)), h), d(n, r, o, h), a && u(m(a, g(r, s, o + 1)), h)), d(s, null, o, h), new i(h)
                                }(e, t, o, n, s))
                            } {
                                let t = e.parent,
                                    i = t.content;
            ...
            class T {
                ...
                static parse(t, e) {
                        ...
                        do n.push(function(e) {
                            ...
                            do n.push(function(e) {
                                ...
                                for (;;)
                                    ...
                                    let n = A(t),
                                        r = n;
                                    return t.eat(",") && (r = "}" != t.next ? A(t) : -1), t.eat("}") || t.err("Unclosed braced range"), {
                                        type: "range",
                                        min: n,
                                        max: r,
                                        expr: e
                    ...
                    let o = (n = function(t) {
                    ...
                    }(s), r = Object.create(null), function t(e) {
                        let i = [];
                        e.forEach(t => {
                            n[t].forEach(({
                                term: t,
                        ...
                        let s = r[e.join(",")] = new T(e.indexOf(n.length - 1) > -1);
                ...
                computeWrapping(t) {
                    ...
                    for (; n.length;) {
                        ...
                        for (let t = 0; t < i.next.length; t++) {
                            ...
                            s.isLeaf || s.hasRequiredAttrs() || s.name in e || r.type && !o.validEnd || (n.push({
            ...
            function z(t, e, n, r) {
                for (let r in e)
                    if (!(r in t)) throw RangeError(`Unsupported attribute ${r} for ${n} of type ${r}`);
                for (let n in t) {
                    let r = t[n];
            ...
            function F(t, e) {
                let n = Object.create(null);
                if (e)
                    for (let r in e) n[r] = new B(t, r, e[r]);
                return n
            }
            class $ {
                constructor(t, e, n) {
                    this.name = t, this.schema = e, this.spec = n, this.markSet = null, this.groups = n.group ? n.group.split(" ") : [], this.attrs = F(t, n.attrs), this.defaultAttrs = N(this.attrs), this.contentMatch = null, this.inlineContent = null, this.isBlock = !(n.inline || "text" == t), this.isText = "text" == t
                }
                get isInline() {
                    return !this.isBlock
                }
            ...
            class B {
                constructor(t, e, n) {
                    let r;
                    this.hasDefault = Object.prototype.hasOwnProperty.call(n, "default"), this.default = n.default, this.validate = "string" == typeof n.validate ? (r = n.validate.split("|"), n => {
            ...
            class J {
                constructor(t, e, n, r) {
                    this.name = t, this.rank = e, this.schema = n, this.spec = r, this.attrs = F(t, r.attrs), this.excluded = null;
                    let i = N(this.attrs);
                ...
                static compile(t, e) {
                    let n = Object.create(null),
                        r = 0;
                    return t.forEach((t, i) => n[t] = new J(t, r++, e, i)), n
                }
                removeFromSet(t) {
            ...
            class D {
                constructor(t) {
                    ...
                    e.nodes = r.from(t.nodes), e.marks = r.from(t.marks || {}), this.nodes = $.compile(this.spec.nodes, this), this.marks = J.compile(this.spec.marks, this);
                    let n = Object.create(null);
                    for (let t in this.nodes) {
                        ...
                        let e = this.nodes[t],
                            r = e.spec.content || "",
                            i = e.spec.marks;
                        if (e.contentMatch = n[r] || (n[r] = T.parse(r, this.nodes)), e.inlineContent = e.contentMatch.inlineContent, e.spec.linebreakReplacement) {
                    ...
                    this.nodeFromJSON = t => b.fromJSON(this, t), this.markFromJSON = t => a.fromJSON(this, t), this.topNodeType = this.nodes[this.spec.topNode || "doc"], this.cached.wrappings = Object.create(null)
                }
                node(t, e = null, n, r) {
            ...
            class Y {
                ...
                matchTag(t, e, n) {
                    for (let i = n ? this.tags.indexOf(n) + 1 : 0; i < this.tags.length; i++) {
                        var r;
                        let n = this.tags[i];
                        if (r = n.tag, (t.matches || t.msMatchesSelector || t.webkitMatchesSelector || t.mozMatchesSelector).call(t, r) && (void 0 === n.namespace || t.namespaceURI == n.namespace) && (!n.context || e.matchesContext(n.context))) {
                            if (n.getAttrs) {
                                let e = n.getAttrs(t);
                                if (!1 === e) continue;
                                n.attrs = e || void 0
                ...
                static schemaRules(t) {
                    ...
                    for (let e in t.marks) {
                        ...
                        r && r.forEach(t => {
                            n(t = V(t)), t.mark || t.ignore || t.clearMark || (t.mark = e)
                        })
                    }
            ...
            class L {
                constructor(t, e, n) {
                    ...
                    let r = e.topNode,
                        i, s = P(null, e.preserveWhitespace, 0) | (n ? 4 : 0);
                    i = r ? new _(r.type, r.attrs, a.none, !0, e.topMatch || r.type.contentMatch, s) : n ? new _(null, null, a.none, !0, null, s) : new _(t.schema.topNodeType, null, a.none, !0, null, s), this.nodes = [i], this.find = e.findPositions, this.needsBlock = !1
                }
                get top() {
                ...
                addElement(t, e, n) {
                    ...
                    t: if (l ? l.ignore : W.hasOwnProperty(s)) this.findInside(t), this.ignoreFallback(t, e);
                        else
                    if (!l || l.skip || l.closeParent) {
                        ...
                        if (H.hasOwnProperty(s)) i.content.length && i.content[0].isInline && this.open && (this.open--, i = this.top), n = !0, i.type || (this.needsBlock = !0);
                ...
                addElementByRule(t, e, n, r) {
                    let i, s;
                    if (e.node) {
                        if ((s = this.parser.schema.nodes[e.node]).isLeaf) this.insertNode(s.create(e.attrs), n, "BR" == t.nodeName) || this.leafFallback(t, n);
                        else {
                ...
                findPlace(t, e, n) {
                    ...
                    for (let e = this.open, s = 0; e >= 0; e--) {
                        let o = this.nodes[e],
                            l = o.findWrapping(t);
                        if (l && (!r || r.length > l.length + s) && (r = l, i = o, !l.length)) break;
                        if (o.solid) {
                            if (n) break;
                            s += 2
                        }
                ...
                insertNode(t, e, n) {
                    ...
                    if (r) {
                        ...
                        let n = a.none;
                        for (let i of r.concat(t.marks))(e.type ? e.type.allowsMarkType(i.type) : K(i.type, t.type)) && (n = i.addToSet(n));
                ...
                enterInner(t, e, n, r = !1, i) {
                    ...
                    let o = P(t, i, s.options);
                    4 & s.options && 0 == s.content.length && (o |= 4);
                    let l = a.none;
                    return n = n.filter(e => (s.type ? !s.type.allowsMarkType(e.type) : !K(e.type, t)) || (l = e.addToSet(l), !1)), this.nodes.push(new _(t, e, l, r, null, o)), this.open++, n
                }
                closeExtra(t = !1) {
                ...
                findAround(t, e, n) {
                    if (t != e && this.find)
                        for (let r = 0; r < this.find.length; r++) null == this.find[r].pos && 1 == t.nodeType && t.contains(this.find[r].node) && e.compareDocumentPosition(this.find[r].node) & (n ? 2 : 4) && (this.find[r].pos = this.currentPos)
                }
                findInText(t) {
                    if (this.find)
            ...
            class U {
                ...
                serializeFragment(t, e = {}, n) {
                    n || (n = Z(e).createDocumentFragment());
                    let r = n,
                        i = [];
                    return t.forEach(t => {
                ...
                serializeNodeInner(t, e) {
                    let {
                        dom: n,
                        contentDOM: r
                    } = X(Z(e), this.nodes[t.type.name](t), null, t.attrs);
                    if (r) {
                ...
                serializeMark(t, e, n = {}) {
                    ...
                    return r && X(Z(n), r(t, e), null, t.attrs)
                }
                static renderSpec(t, e, n = null, r) {
                    return X(t, e, n, r)
                }
                static fromSchema(t) {
                    return t.cached.domSerializer || (t.cached.domSerializer = new U(this.nodesFromSchema(t), this.marksFromSchema(t)))
                }
            ...
            function X(t, e, n, r) {
                ...
                if (r && (void 0 === (s = Q.get(r)) && Q.set(r, (o = null, function t(e) {
                    ...
                    }(r), s = o)), a = s) && a.indexOf(e) > -1) throw RangeError("Using an array from an attribute object as a DOM spec. This may be an attempted cross site scripting attack.");
                let h = l.indexOf(" ");
                ...
                if (p && "object" == typeof p && null == p.nodeType && !Array.isArray(p)) {
                    for (let t in f = 2, p)
                        if (null != p[t]) {
                            let e = t.indexOf(" ");
                            e > 0 ? c.setAttributeNS(t.slice(0, e), t.slice(e + 1), p[t]) : "style" == t && c.style ? c.style.cssText = p[t] : c.setAttribute(t, p[t])
                        }
                }
                for (let s = f; s < e.length; s++) {
                    let o = e[s];
                    if (0 === o) {
                        if (s < e.length - 1 || s > f) throw RangeError("Content hole must be the only child of its parent node");
                        return {
                            dom: c,
                            contentDOM: c
                        }
            ...
            function s(t, e = null) {
                return function(n, s) {
                    let {
                        $from: o,
                        $to: l
                    } = n.selection, a = o.blockRange(l);
                    if (!a) return !1;
                    let h = s ? n.tr : null;
                    return !! function(t, e, n, s = null) {
                        let o = !1,
                            l = e,
                            a = e.$from.doc;
                        if (e.depth >= 2 && e.$from.node(e.depth - 1).type.compatibleContent(n) && 0 == e.startIndex) {
                            ...
                            l = new i.Ts(t, t, e.depth), e.endIndex < e.parent.childCount && (e = new i.Ts(e.$from, a.resolve(e.$to.end(e.depth)), e.depth)), o = !0
                        }
                        let h = (0, r.nd)(l, n, s, e);
                        return !!h && (t && function(t, e, n, s, o) {
                            let l = i.HY.empty;
                    ...
                    }(h, a, t, e) && (s && s(h.scrollIntoView()), !0)
                }
            }
            ...
            function o(t) {
                return function(e, n) {
                    let {
                        $from: s,
                        $to: o
                    } = e.selection, l = s.blockRange(o, e => e.childCount > 0 && e.firstChild.type == t);
                    return !!l && (!n || (s.node(l.depth - 1).type == t ? function(t, e, n, s) {
                        let o = t.tr,
                            l = s.end,
                            a = s.$to.end(s.depth);
                        ...
                        if (null == h) return !1;
                        o.lift(s, h);
                        let c = o.doc.resolve(o.mapping.map(l, -1) - 1);
                        return (0, r.Mn)(o.doc, c.pos) && c.nodeBefore.type == c.nodeAfter.type && o.join(c.pos), e(o.scrollIntoView()), !0
                    }(e, n, t, l) : function(t, e, n) {
                        let s = t.tr,
                            o = n.parent;
                        ...
                        let h = 0 == n.startIndex,
                            ...
                            p = l.node(-1),
                            f = l.index(-1);
                        if (!p.canReplace(f + (h ? 0 : 1), f + 1, a.content.append(c ? i.HY.empty : i.HY.from(o)))) return !1;
                        let u = l.pos,
                            d = u + a.nodeSize;
                        return s.step(new r.FC(u - (h ? 1 : 0), d + (c ? 1 : 0), u + 1, d - 1, new i.p2((h ? i.HY.empty : i.HY.from(o.copy(i.HY.empty))).append(c ? i.HY.empty : i.HY.from(o.copy(i.HY.empty))), h ? 0 : 1, c ? 0 : 1), h ? 0 : 1)), e(s.scrollIntoView()), !0
                    }(e, n, l)))
                }
            }
                ...
                return function(e, n) {
                    ...
                    if (n) {
                        let s = c.lastChild && c.lastChild.type == h.type,
                            ...
                            p = l.start,
                            f = l.end;
                        n(e.tr.step(new r.FC(p - (s ? 3 : 1), f, p, f, a, 1, !0)).scrollIntoView())
                    }
                    return !0
                }
            }
        ...
        27191: function(t, e, n) {
            ...
            class o {
                ...
                replaceWith(t, e) {
                    ...
                    for (let i = 0; i < r.length; i++) {
                        let {
                            $from: s,
                            $to: o
                        } = r[i], l = t.mapping.slice(n), a = l.map(s.pos), h = l.map(o.pos);
                ...
                static near(t, e = 1) {
                    return this.findFrom(t, e) || this.findFrom(t, -e) || new d(t.node(0))
                }
                static atStart(t) {
            ...
            function g(t, e, n, r, i, s = !1) {
                ...
                for (let o = r - (i > 0 ? 0 : 1); i > 0 ? o < e.childCount : o >= 0; o += i) {
                    let r = e.child(o);
                    if (r.isAtom) {
                        if (!s && f.isSelectable(r)) return f.create(t, n - (i < 0 ? r.nodeSize : 0))
                    } else {
            ...
            function y(t, e, n) {
                let r, s = t.steps.length - 1;
                if (s < e) return;
                let l = t.steps[s];
                (l instanceof i.Pu || l instanceof i.FC) && (t.mapping.maps[s].forEach((t, e, n, i) => {
                    null == r && (r = i)
                }), t.setSelection(o.near(t.doc.resolve(r), n)))
            }
            class k extends i.wx {
                constructor(t) {
            ...
            class v {
                constructor(t, e) {
                    this.schema = t, this.plugins = [], this.pluginsByKey = Object.create(null), this.fields = S.slice(), e && e.forEach(t => {
                        if (this.pluginsByKey[t.key]) throw RangeError("Adding different instances of a keyed plugin (" + t.key + ")");
                        this.plugins.push(t), this.pluginsByKey[t.key] = t, t.spec.state && this.fields.push(new x(t.key, t.spec.state, t))
                    })
                }
            }
            class b {
                            ...
                            if (o.spec.appendTransaction) {
                                ...
                                if (h && n.filterTransaction(h, s)) {
                                    if (h.setMeta("appendedTransaction", t), !r) {
                                        r = [];
                                        for (let t = 0; t < this.config.plugins.length; t++) r.push(t < s ? {
                                            state: n,
                                            n: e.length
                                        } : {
                                            state: this,
            ...
            class C {
                constructor(t) {
                    this.spec = t, this.props = {}, t.props && function t(e, n, r) {
                        ...
                        return r
                    }(t.props, this, this.props), this.key = t.key ? t.key.key : T("plugin")
                }
                getState(t) {
                    return t[this.key]
                }
        ...
        26151: function(t, e, n) {
                    ...
                    for (let l = 0; l < this.ranges.length; l += 3) {
                        ...
                        if (t <= p) {
                            let s = h ? t == a ? -1 : t == p ? 1 : e : e,
                                o = a + r + (s < 0 ? 0 : c);
                            if (n) return o;
                            let f = t == (e < 0 ? a : p) ? null : l / 3 + (t - a) * 65536,
                                u = t == a ? 2 : t == p ? 1 : 4;
                            return (e < 0 ? t != a : t != p) && (u |= 8), new i(o, u, f)
                        }
                        r += c - h
                    }
            ...
            class o {
                ...
                slice(t = 0, e = this.maps.length) {
                    return new o(this._maps, this.mirror, t, e)
                }
                appendMap(t, e) {
            ...
            class p extends a {
                ...
                apply(t) {
                    let e = t.slice(this.from, this.to),
                        ...
                        s = new r.p2(c(e.content, (t, e) => t.isAtom && e.type.allowsMarkType(this.mark.type) ? t.mark(this.mark.addToSet(t.marks)) : t, i), e.openStart, e.openEnd);
            ...
            class f extends a {
                ...
                apply(t) {
                    let e = t.slice(this.from, this.to),
                        n = new r.p2(c(e.content, t => t.mark(this.mark.removeFromSet(t.marks)), t), e.openStart, e.openEnd);
            ...
            class u extends a {
                    ...
                    if (e) {
                        ...
                        if (t.length == e.marks.length) {
                            for (let n = 0; n < e.marks.length; n++)
                                if (!e.marks[n].isInSet(t)) return new u(this.pos, e.marks[n]);
                ...
                map(t) {
                    ...
                    return e.deletedAfter ? null : new u(e.pos, this.mark)
                }
                toJSON() {
                    return {
                ...
                static fromJSON(t, e) {
                    ...
                    return new u(e.pos, t.markFromJSON(e.mark))
                }
            }
            a.jsonID("addNodeMark", u);
            class d extends a {
                constructor(t, e) {
                    super(), this.pos = t, this.mark = e
                }
                ...
                invert(t) {
                    let e = t.nodeAt(this.pos);
                    return e && this.mark.isInSet(e.marks) ? new u(this.pos, this.mark) : this
                }
                map(t) {
                    let e = t.mapResult(this.pos, 1);
            ...
            class m extends a {
                ...
                map(t) {
                    let e = t.mapResult(this.from, 1),
                        n = t.mapResult(this.to, -1);
                    return e.deletedAcross && n.deletedAcross ? null : new m(e.pos, Math.max(e.pos, n.pos), this.slice, this.structure)
                }
                merge(t) {
            ...
            function k(t, e, n, i = n.contentMatch, s = !0) {
                ...
                for (let e = 0; e < o.childCount; e++) {
                    ...
                    if (p) {
                        i = p;
                        for (let e = 0; e < h.marks.length; e++) n.allowsMarkType(h.marks[e].type) || t.step(new f(a, c, h.marks[e]));
            ...
            function x(t, e, n = null, r = t) {
                let i = function(t, e) {
                        let {
                            ...
                            startIndex: r,
                            endIndex: i
                        } = t, s = n.contentMatchAt(r).findWrapping(e);
                        if (!s) return null;
            ...
            function T(t, e) {
                return !!(t && e && !t.isLeaf && function(t, e) {
            ...
            function O(t, e, n = -1) {
                ...
                for (let t = r.depth;; t--) {
                    let i, s, o = r.index(t);
                    if (t == r.depth ? (i = r.nodeBefore, s = r.nodeAfter) : n > 0 ? (i = r.node(t + 1), o++, s = r.node(t).maybeChild(o)) : (i = r.node(t).maybeChild(o - 1), s = r.node(t + 1)), i && !i.isTextblock && T(i, s) && r.node(t).canReplace(o, o + 1)) return e;
                    if (0 == t) break;
            ...
            function E(t, e, n = e, i = r.p2.empty) {
                ...
                let s = t.resolve(e),
                    o = t.resolve(n);
                return I(s, o, i) ? new m(e, n, i) : new N(s, o, i).fit()
            }
            ...
            class N {
                ...
                findFittable() {
                    ...
                    for (let e = 1; e <= 2; e++)
                        for (let n = 1 == e ? t : this.unplaced.openStart; n >= 0; n--) {
                            let t = null,
                                i = (n ? (t = F(this.unplaced.content, n - 1).firstChild).content : this.unplaced.content).firstChild;
                            for (let s = this.depth; s >= 0; s--) {
                                let {
                                    type: o,
                                    match: l
                                } = this.frontier[s], a, h = null;
                                if (1 == e && (i ? l.matchType(i.type) || (h = l.fillBefore(r.HY.from(i), !1)) : t && o.compatibleContent(t.type))) return {
                                    sliceDepth: n,
                                    frontierDepth: s,
                                    parent: t,
                                    inject: h
                                };
                                if (2 == e && i && (a = l.findWrapping(i.type))) return {
                                    sliceDepth: n,
                                    frontierDepth: s,
                                    parent: t,
                                    wrap: a
                ...
                placeNodes({
                    ...
                    if (s)
                        for (let t = 0; t < s.length; t++) this.openFrontierNode(s[t]);
                    let o = this.unplaced,
                    ...
                    let u = l.size + t - (o.content.size - o.openEnd);
                    for (; h < l.childCount;) {
                        let t = l.child(h),
                            e = p.matchType(t.type);
                        if (!e) break;
                        (++h > 1 || 0 == a || t.content.size) && (p = e, c.push(function t(e, n, i) {
                            if (n <= 0) return e;
                            let s = e.content;
                            return n > 1 && (s = s.replaceChild(0, t(s.firstChild, n - 1, 1 == s.childCount ? i - 1 : 0))), n > 0 && (s = e.type.contentMatch.fillBefore(s).append(s), i <= 0 && (s = s.append(e.type.contentMatch.matchFragment(s).fillBefore(r.HY.empty, !0)))), e.copy(s)
                        }(t.mark(f.allowedMarks(t.marks)), 1 == h ? a : 0, h == l.childCount ? u : -1)))
                    }
                    let d = h == l.childCount;
                    d || (u = -1), this.placed = z(this.placed, e, r.HY.from(c)), this.frontier[e].match = p, d && u < 0 && n && n.type == this.frontier[this.depth].type && this.frontier.length > 1 && this.closeFrontierNode();
                    for (let t = 0, e = l; t < u; t++) {
                        let t = e.lastChild;
                        this.frontier.push({
                            type: t.type,
                    ...
                    this.unplaced = d ? 0 == t ? r.p2.empty : new r.p2(R(o.content, t - 1, 1), t - 1, u < 0 ? o.openEnd : t - 1) : new r.p2(R(o.content, t, h), o.openStart, o.openEnd)
                }
                mustMoveInline() {
                    if (!this.$to.parent.isTextblock) return -1;
                    let t = this.frontier[this.depth],
                        e;
                    if (!t.type.isTextblock || !$(this.$to, this.$to.depth, t.type, t.match, !1) || this.$to.depth == this.depth && (e = this.findCloseLevel(this.$to)) && e.depth == this.depth) return -1;
                    let {
                        depth: n
                ...
                findCloseLevel(t) {
                    e: for (let e = Math.min(this.depth, t.depth); e >= 0; e--) {
                        let {
                            match: n,
                            type: r
                        } = this.frontier[e], i = e < t.depth && t.end(e + 1) == t.pos + (t.depth - (e + 1)), s = $(t, e, r, n, i);
                        if (s) {
                            for (let n = e - 1; n >= 0; n--) {
                                let {
                                    match: e,
                                    type: r
                                } = this.frontier[n], i = $(t, n, r, e, !0);
                ...
                openFrontierNode(t, e = null, n) {
                    ...
                    i.match = i.match.matchType(t), this.placed = z(this.placed, this.depth, r.HY.from(t.create(e, n))), this.frontier.push({
                        type: t,
            ...
            class J extends a {
                ...
                invert(t) {
                    return new J(this.pos, this.attr, t.nodeAt(this.pos).attrs[this.attr])
                }
                map(t) {
                    let e = t.mapResult(this.pos, 1);
            ...
            class D extends a {
                ...
                invert(t) {
                    return new D(this.attr, t.attrs[this.attr])
                }
                map(t) {
                    return this
                }
            ...
            }).prototype = Object.create(Error.prototype), j.prototype.constructor = j, j.prototype.name = "TransformError";
            class Y {
                constructor(t) {
                ...
                replaceRange(t, e, n) {
                    return ! function(t, e, n, i) {
                        ...
                        let s = t.doc.resolve(e),
                            o = t.doc.resolve(n);
                        if (I(s, o, i)) return t.step(new m(e, n, i));
                        ...
                        for (let e = i.openStart; e >= 0; e--) {
                            ...
                            if (f)
                                for (let e = 0; e < l.length; e++) {
                                    ...
                                    let u = s.node(c - 1),
                                        d = s.index(c - 1);
                                    if (u.canReplaceWith(d, d, f.type, f.marks)) return t.replace(s.before(c), p ? o.after(c) : n, new r.p2(function t(e, n, i, s, o) {
                                        if (n < i) {
                                            let r = e.firstChild;
                                        ...
                                        return e
                                    }(i.content, 0, i.openStart, a), a, i.openEnd))
                                }
                        }
                        let u = t.steps.length;
                        for (let r = l.length - 1; r >= 0 && (t.replace(e, n, i), !(t.steps.length > u)); r--) {
                            let t = l[r];
                ...
                deleteRange(t, e) {
                    return ! function(t, e, n) {
                        ...
                        for (let s = 1; s <= r.depth && s <= i.depth; s++)
                            if (e - r.start(s) == r.depth - s && n > r.end(s) && i.end(s) - n != i.depth - s && r.start(s - 1) == i.start(s - 1) && r.node(s - 1).canReplace(r.index(s - 1), i.index(s - 1))) return t.delete(r.before(s), n);
                        t.delete(e, n)
                    }(this, t, e), this
                }
                lift(t, e) {
                    return ! function(t, e, n) {
                        let {
                            ...
                            $to: s,
                            depth: o
                        } = e, l = i.before(o + 1), a = s.after(o + 1), h = l, c = a, p = r.HY.empty, f = 0;
                        for (let t = o, e = !1; t > n; t--) e || i.index(t) > 0 ? (e = !0, p = r.HY.from(i.node(t).copy(p)), f++) : h--;
                        let u = r.HY.empty,
                            d = 0;
                        for (let t = o, e = !1; t > n; t--) e || s.after(t + 1) < s.end(t) ? (e = !0, u = r.HY.from(s.node(t).copy(u)), d++) : c++;
                        t.step(new g(h, c, l, a, new r.p2(p.append(u), f, d), p.size - f, !0))
                    }(this, t, e), this
                }
                join(t, e = 1) {
                    return ! function(t, e, n) {
                        ...
                        l.inlineContent && k(t, e + n - 1, l, o.node().contentMatchAt(o.index()), null == i);
                ...
                setBlockType(t, e = t, n, i = null) {
                    return ! function(t, e, n, i, s) {
                        ...
                        t.doc.nodesBetween(e, n, (e, n) => {
                            var l, a;
                            let h, c, p = "function" == typeof s ? s(e) : s;
                            if (e.isTextblock && !e.hasMarkup(i, p) && (l = t.doc, a = t.mapping.slice(o).map(n), c = (h = l.resolve(a)).index(), h.parent.canReplaceWith(c, c + 1, i))) {
                                ...
                                if (i.schema.linebreakReplacement) {
                                    ...
                                    t && !e ? s = !1 : !t && e && (s = !0)
                                }!1 === s && b(t, e, n, o), k(t, t.mapping.slice(o).map(n, 1), i, void 0, null === s);
                ...
                addNodeMark(t, e) {
                    return this.step(new u(t, e)), this
                }
                removeNodeMark(t, e) {
                    let n = this.doc.nodeAt(t);
                    if (!n) throw RangeError("No node at position " + t);
                    if (e instanceof r.vc) e.isInSet(n.marks) && this.step(new d(t, e));
                    else {
                        let r = n.marks,
                            i, s = [];
                        for (; i = e.isInSet(r);) s.push(new d(t, i)), r = i.removeFromSet(r);
                        for (let t = s.length - 1; t >= 0; t--) this.step(s[t])
                    }
                    return this
                }
                split(t, e = 1, n) {
                ...
                addMark(t, e, n) {
                    var r;
                    let i, s, o, l;
                    return r = this, o = [], l = [], r.doc.nodesBetween(t, e, (r, a, h) => {
                        if (!r.isInline) return;
                        let c = r.marks;
                        if (!n.isInSet(c) && h.type.allowsMarkType(n.type)) {
                            let h = Math.max(a, t),
                                u = Math.min(a + r.nodeSize, e),
                                d = n.addToSet(c);
                            for (let t = 0; t < c.length; t++) c[t].isInSet(d) || (i && i.to == h && i.mark.eq(c[t]) ? i.to = u : o.push(i = new f(h, u, c[t])));
                            s && s.to == h ? s.to = u : l.push(s = new p(h, u, n))
                        }
                    }), o.forEach(t => r.step(t)), l.forEach(t => r.step(t)), this
                }
                removeMark(t, e, n) {
                    var i;
                    let s, o;
                    return i = this, s = [], o = 0, i.doc.nodesBetween(t, e, (i, l) => {
                    ...
                    }), s.forEach(t => i.step(new f(t.from, t.to, t.style))), this
                }
